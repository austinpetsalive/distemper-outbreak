...
| ------------------------- | ------------------------------------------------------------------------------------ | :------------------------: | ----------------------------: |
| pSusceptibleIntake        | Literature Review of [1](https://www.sciencedirect.com/science/article/pii/S0378113511006705?via%3Dihub), [2](https://www.tandfonline.com/doi/full/10.1080/10888705.2018.1435281?scroll=top&needAccess=true), [3](https://avmajournals.avma.org/doi/abs/10.2460/javma.236.12.1317) to determine average rate of 1-0.41 in population across 4 shelters, extrapolated to AAC data and applied to equation (1) | probability/hour           | ???                           |
| pInfectIntake             | ???                                                                                  | probability/hour           | ???                           |
| pSymptomaticIntake        | Assumed | probability/hour           | 0                           |
...
| immunity_growth_factors   | Assumed to follow Michaelis-Menten Kinetics with fit to 0 and t=0 and 0.9 at t=1                                                                                  | list of 0-1 bounded values | ???                           |
