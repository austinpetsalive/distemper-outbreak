    ...
    class State(object):
        def __init__(self, id, name, update_function, transition_functions, response_functions, members=[]):
            self.id = id
            self.name = name
            ...
            assert len(self.transition_functions) == len(self.response_functions), "transition_functions and response_functions should be the same length"
